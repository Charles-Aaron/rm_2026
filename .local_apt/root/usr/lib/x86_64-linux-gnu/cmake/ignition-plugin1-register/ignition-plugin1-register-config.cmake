# - Config file for the ignition-plugin1-register component
#
# This should only be invoked by ignition-plugin1-config.cmake.
#
# To load this component into your project, use:
# find_package(ignition-plugin1 COMPONENTS register)
#
# This creates the following targets:
#
#   Component library target                - ignition-plugin1::ignition-plugin1-register
#   Alternative target name                 - ignition-plugin1::register
...
# this is discouraged:
#
#   ignition-plugin1-register_LIBRARY  - Component library (actually contains ignition-plugin1::register)
#
# We will also set ignition-plugin1-register_FOUND to indicate that the component was found.
#
################################################################################
...
if(ignition-plugin1-register_CONFIG_INCLUDED)
  return()
endif()
set(ignition-plugin1-register_CONFIG_INCLUDED TRUE)

if(NOT ignition-plugin1-register_FIND_QUIETLY)
  message(STATUS "Looking for ignition-plugin1-register -- found version 1.4.0")
endif()
...
get_filename_component(_realOrig "/usr/lib/x86_64-linux-gnu/cmake/ignition-plugin1-register" REALPATH)
...
# dependencies.
if(ignition-plugin1-register_FIND_REQUIRED)
...
# dependencies.
if(ignition-plugin1-register_FIND_QUIETLY)
...
if(NOT ignition-plugin1-register_FIND_QUIETLY)
  message(STATUS "Searching for dependencies of ignition-plugin1-register")
endif()
...
if(NOT TARGET ignition-plugin1::ignition-plugin1-register)
  include("${CMAKE_CURRENT_LIST_DIR}/ignition-plugin1-register-targets.cmake")

  # Create a simplified imported target name for the register library.
  # You can link to this target instead of the register library.
  add_library(ignition-plugin1::register INTERFACE IMPORTED)
  set_target_properties(ignition-plugin1::register PROPERTIES
    INTERFACE_LINK_LIBRARIES "ignition-plugin1::ignition-plugin1-register")
...
# Link the register library to the "requested" target
...
if(NOT ign_requested_components)
  ...
  set_target_properties(ignition-plugin1::requested PROPERTIES
    INTERFACE_LINK_LIBRARIES "${ign_requested_components};ignition-plugin1::ignition-plugin1-register")
endif()

set(ignition-plugin1-register_LIBRARY ignition-plugin1::ignition-plugin1-register)

# This macro is used by ignition-cmake to automatically configure the pkgconfig
# files for ignition projects.
ign_pkg_config_entry(ignition-plugin1-register "ignition-plugin1-register")
