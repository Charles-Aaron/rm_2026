# - Config file for the ignition-rendering6-ogre2 component
#
# This should only be invoked by ignition-rendering6-config.cmake.
#
# To load this component into your project, use:
# find_package(ignition-rendering6 COMPONENTS ogre2)
#
# This creates the following targets:
#
#   Component library target                - ignition-rendering6::ignition-rendering6-ogre2
#   Alternative target name                 - ignition-rendering6::ogre2
...
# this is discouraged:
#
#   ignition-rendering6-ogre2_LIBRARY  - Component library (actually contains ignition-rendering6::ogre2)
#
# We will also set ignition-rendering6-ogre2_FOUND to indicate that the component was found.
#
################################################################################
...
if(ignition-rendering6-ogre2_CONFIG_INCLUDED)
  return()
endif()
set(ignition-rendering6-ogre2_CONFIG_INCLUDED TRUE)

if(NOT ignition-rendering6-ogre2_FIND_QUIETLY)
  message(STATUS "Looking for ignition-rendering6-ogre2 -- found version 6.6.3")
endif()
...
get_filename_component(_realOrig "/usr/lib/x86_64-linux-gnu/cmake/ignition-rendering6-ogre2" REALPATH)
...
# dependencies.
if(ignition-rendering6-ogre2_FIND_REQUIRED)
...
# dependencies.
if(ignition-rendering6-ogre2_FIND_QUIETLY)
...
if(NOT ignition-rendering6-ogre2_FIND_QUIETLY)
  message(STATUS "Searching for dependencies of ignition-rendering6-ogre2")
endif()
...
if(NOT TARGET ignition-rendering6::ignition-rendering6-ogre2)
  include("${CMAKE_CURRENT_LIST_DIR}/ignition-rendering6-ogre2-targets.cmake")

  # Create a simplified imported target name for the ogre2 library.
  # You can link to this target instead of the ogre2 library.
  add_library(ignition-rendering6::ogre2 INTERFACE IMPORTED)
  set_target_properties(ignition-rendering6::ogre2 PROPERTIES
    INTERFACE_LINK_LIBRARIES "ignition-rendering6::ignition-rendering6-ogre2")
...
if(NOT ign_requested_components)
  ...
  set_target_properties(ignition-rendering6::requested PROPERTIES
    INTERFACE_LINK_LIBRARIES "${ign_requested_components};ignition-rendering6::ignition-rendering6-ogre2")
endif()

set(ignition-rendering6-ogre2_LIBRARY ignition-rendering6::ignition-rendering6-ogre2)

# This macro is used by ignition-cmake to automatically configure the pkgconfig
# files for ignition projects.
ign_pkg_config_entry(ignition-rendering6-ogre2 "ignition-rendering6-ogre2")
