...
get_filename_component(_realOrig "/usr/lib/x86_64-linux-gnu/cmake/Qt5QuickTemplates2" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5QuickTemplates2_install_prefix "/usr/lib/x86_64-linux-gnu/../../" ABSOLUTE)
else()
...
set(Qt5QuickTemplates2_VERSION_STRING 5.15.3)
...
macro(_populate_QuickTemplates2_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5QuickTemplates2_install_prefix}/lib/x86_64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::QuickTemplates2)
    ...
    set(_Qt5QuickTemplates2_OWN_INCLUDE_DIRS "${_qt5QuickTemplates2_install_prefix}/include/x86_64-linux-gnu/qt5/" "${_qt5QuickTemplates2_install_prefix}/include/x86_64-linux-gnu/qt5/QtQuickTemplates2")
    set(Qt5QuickTemplates2_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickTemplates2_install_prefix}/include/x86_64-linux-gnu/qt5/QtQuickTemplates2/5.15.3"
        "${_qt5QuickTemplates2_install_prefix}/include/x86_64-linux-gnu/qt5/QtQuickTemplates2/5.15.3/QtQuickTemplates2"
    )
    ...
    foreach(_module_dep ${_Qt5QuickTemplates2_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.3 ${_Qt5QuickTemplates2_FIND_VERSION_EXACT}
    ...
    _populate_QuickTemplates2_target_properties(RELEASE "libQt5QuickTemplates2.so.5.15.3" "" FALSE)
    ...
    macro(_populate_QuickTemplates2_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5QuickTemplates2_install_prefix}/lib/x86_64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_QuickTemplates2_check_file_exists(${imported_location})
