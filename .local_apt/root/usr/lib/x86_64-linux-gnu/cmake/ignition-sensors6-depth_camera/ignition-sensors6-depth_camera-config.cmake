# - Config file for the ignition-sensors6-depth_camera component
#
# This should only be invoked by ignition-sensors6-config.cmake.
#
# To load this component into your project, use:
# find_package(ignition-sensors6 COMPONENTS depth_camera)
#
# This creates the following targets:
#
#   Component library target                - ignition-sensors6::ignition-sensors6-depth_camera
#   Alternative target name                 - ignition-sensors6::depth_camera
...
# this is discouraged:
#
#   ignition-sensors6-depth_camera_LIBRARY  - Component library (actually contains ignition-sensors6::depth_camera)
#
# We will also set ignition-sensors6-depth_camera_FOUND to indicate that the component was found.
#
################################################################################
...
if(ignition-sensors6-depth_camera_CONFIG_INCLUDED)
  return()
endif()
set(ignition-sensors6-depth_camera_CONFIG_INCLUDED TRUE)

if(NOT ignition-sensors6-depth_camera_FIND_QUIETLY)
  message(STATUS "Looking for ignition-sensors6-depth_camera -- found version 6.8.0")
endif()
...
get_filename_component(_realOrig "/usr/lib/x86_64-linux-gnu/cmake/ignition-sensors6-depth_camera" REALPATH)
...
# dependencies.
if(ignition-sensors6-depth_camera_FIND_REQUIRED)
...
# dependencies.
if(ignition-sensors6-depth_camera_FIND_QUIETLY)
...
if(NOT ignition-sensors6-depth_camera_FIND_QUIETLY)
  message(STATUS "Searching for dependencies of ignition-sensors6-depth_camera")
endif()
...
if(NOT TARGET ignition-sensors6::ignition-sensors6-depth_camera)
  include("${CMAKE_CURRENT_LIST_DIR}/ignition-sensors6-depth_camera-targets.cmake")

  # Create a simplified imported target name for the depth_camera library.
  # You can link to this target instead of the depth_camera library.
  add_library(ignition-sensors6::depth_camera INTERFACE IMPORTED)
  set_target_properties(ignition-sensors6::depth_camera PROPERTIES
    INTERFACE_LINK_LIBRARIES "ignition-sensors6::ignition-sensors6-depth_camera")
...
# Link the depth_camera library to the "requested" target
...
if(NOT ign_requested_components)
  ...
  set_target_properties(ignition-sensors6::requested PROPERTIES
    INTERFACE_LINK_LIBRARIES "${ign_requested_components};ignition-sensors6::ignition-sensors6-depth_camera")
endif()

set(ignition-sensors6-depth_camera_LIBRARY ignition-sensors6::ignition-sensors6-depth_camera)

# This macro is used by ignition-cmake to automatically configure the pkgconfig
# files for ignition projects.
ign_pkg_config_entry(ignition-sensors6-depth_camera "ignition-sensors6-depth_camera")
