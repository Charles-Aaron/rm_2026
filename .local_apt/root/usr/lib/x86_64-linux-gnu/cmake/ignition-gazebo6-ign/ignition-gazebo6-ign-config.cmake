# - Config file for the ignition-gazebo6-ign component
#
# This should only be invoked by ignition-gazebo6-config.cmake.
#
# To load this component into your project, use:
# find_package(ignition-gazebo6 COMPONENTS ign)
#
# This creates the following targets:
#
#   Component library target                - ignition-gazebo6::ignition-gazebo6-ign
#   Alternative target name                 - ignition-gazebo6::ign
...
# this is discouraged:
#
#   ignition-gazebo6-ign_LIBRARY  - Component library (actually contains ignition-gazebo6::ign)
#
# We will also set ignition-gazebo6-ign_FOUND to indicate that the component was found.
#
################################################################################
...
if(ignition-gazebo6-ign_CONFIG_INCLUDED)
  return()
endif()
set(ignition-gazebo6-ign_CONFIG_INCLUDED TRUE)

if(NOT ignition-gazebo6-ign_FIND_QUIETLY)
  message(STATUS "Looking for ignition-gazebo6-ign -- found version 6.16.0")
endif()
...
get_filename_component(_realOrig "/usr/lib/x86_64-linux-gnu/cmake/ignition-gazebo6-ign" REALPATH)
...
# dependencies.
if(ignition-gazebo6-ign_FIND_REQUIRED)
...
# dependencies.
if(ignition-gazebo6-ign_FIND_QUIETLY)
...
if(NOT ignition-gazebo6-ign_FIND_QUIETLY)
  message(STATUS "Searching for dependencies of ignition-gazebo6-ign")
endif()
...
if(NOT TARGET ignition-gazebo6::ignition-gazebo6-ign)
  include("${CMAKE_CURRENT_LIST_DIR}/ignition-gazebo6-ign-targets.cmake")

  # Create a simplified imported target name for the ign library.
  # You can link to this target instead of the ign library.
  add_library(ignition-gazebo6::ign INTERFACE IMPORTED)
  set_target_properties(ignition-gazebo6::ign PROPERTIES
    INTERFACE_LINK_LIBRARIES "ignition-gazebo6::ignition-gazebo6-ign")
...
# Link the ign library to the "requested" target
...
if(NOT ign_requested_components)
  ...
  set_target_properties(ignition-gazebo6::requested PROPERTIES
    INTERFACE_LINK_LIBRARIES "${ign_requested_components};ignition-gazebo6::ignition-gazebo6-ign")
endif()

set(ignition-gazebo6-ign_LIBRARY ignition-gazebo6::ignition-gazebo6-ign)

# This macro is used by ignition-cmake to automatically configure the pkgconfig
# files for ignition projects.
ign_pkg_config_entry(ignition-gazebo6-ign "ignition-gazebo6-ign")
