# - Config file for the ignition-sensors6-lidar component
#
# This should only be invoked by ignition-sensors6-config.cmake.
#
# To load this component into your project, use:
# find_package(ignition-sensors6 COMPONENTS lidar)
#
# This creates the following targets:
#
#   Component library target                - ignition-sensors6::ignition-sensors6-lidar
#   Alternative target name                 - ignition-sensors6::lidar
...
# this is discouraged:
#
#   ignition-sensors6-lidar_LIBRARY  - Component library (actually contains ignition-sensors6::lidar)
#
# We will also set ignition-sensors6-lidar_FOUND to indicate that the component was found.
#
################################################################################
...
if(ignition-sensors6-lidar_CONFIG_INCLUDED)
  return()
endif()
set(ignition-sensors6-lidar_CONFIG_INCLUDED TRUE)

if(NOT ignition-sensors6-lidar_FIND_QUIETLY)
  message(STATUS "Looking for ignition-sensors6-lidar -- found version 6.8.0")
endif()
...
get_filename_component(_realOrig "/usr/lib/x86_64-linux-gnu/cmake/ignition-sensors6-lidar" REALPATH)
...
# dependencies.
if(ignition-sensors6-lidar_FIND_REQUIRED)
...
# dependencies.
if(ignition-sensors6-lidar_FIND_QUIETLY)
...
if(NOT ignition-sensors6-lidar_FIND_QUIETLY)
  message(STATUS "Searching for dependencies of ignition-sensors6-lidar")
endif()
...
if(NOT TARGET ignition-sensors6::ignition-sensors6-lidar)
  include("${CMAKE_CURRENT_LIST_DIR}/ignition-sensors6-lidar-targets.cmake")

  # Create a simplified imported target name for the lidar library.
  # You can link to this target instead of the lidar library.
  add_library(ignition-sensors6::lidar INTERFACE IMPORTED)
  set_target_properties(ignition-sensors6::lidar PROPERTIES
    INTERFACE_LINK_LIBRARIES "ignition-sensors6::ignition-sensors6-lidar")
...
# Link the lidar library to the "requested" target
...
if(NOT ign_requested_components)
  ...
  set_target_properties(ignition-sensors6::requested PROPERTIES
    INTERFACE_LINK_LIBRARIES "${ign_requested_components};ignition-sensors6::ignition-sensors6-lidar")
endif()

set(ignition-sensors6-lidar_LIBRARY ignition-sensors6::ignition-sensors6-lidar)

# This macro is used by ignition-cmake to automatically configure the pkgconfig
# files for ignition projects.
ign_pkg_config_entry(ignition-sensors6-lidar "ignition-sensors6-lidar")
