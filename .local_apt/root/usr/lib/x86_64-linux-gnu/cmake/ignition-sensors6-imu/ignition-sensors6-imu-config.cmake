# - Config file for the ignition-sensors6-imu component
#
# This should only be invoked by ignition-sensors6-config.cmake.
#
# To load this component into your project, use:
# find_package(ignition-sensors6 COMPONENTS imu)
#
# This creates the following targets:
#
#   Component library target                - ignition-sensors6::ignition-sensors6-imu
#   Alternative target name                 - ignition-sensors6::imu
...
# this is discouraged:
#
#   ignition-sensors6-imu_LIBRARY  - Component library (actually contains ignition-sensors6::imu)
#
# We will also set ignition-sensors6-imu_FOUND to indicate that the component was found.
#
################################################################################
...
if(ignition-sensors6-imu_CONFIG_INCLUDED)
  return()
endif()
set(ignition-sensors6-imu_CONFIG_INCLUDED TRUE)

if(NOT ignition-sensors6-imu_FIND_QUIETLY)
  message(STATUS "Looking for ignition-sensors6-imu -- found version 6.8.0")
endif()
...
get_filename_component(_realOrig "/usr/lib/x86_64-linux-gnu/cmake/ignition-sensors6-imu" REALPATH)
...
# dependencies.
if(ignition-sensors6-imu_FIND_REQUIRED)
...
# dependencies.
if(ignition-sensors6-imu_FIND_QUIETLY)
...
if(NOT ignition-sensors6-imu_FIND_QUIETLY)
  message(STATUS "Searching for dependencies of ignition-sensors6-imu")
endif()
...
if(NOT TARGET ignition-sensors6::ignition-sensors6-imu)
  include("${CMAKE_CURRENT_LIST_DIR}/ignition-sensors6-imu-targets.cmake")

  # Create a simplified imported target name for the imu library.
  # You can link to this target instead of the imu library.
  add_library(ignition-sensors6::imu INTERFACE IMPORTED)
  set_target_properties(ignition-sensors6::imu PROPERTIES
    INTERFACE_LINK_LIBRARIES "ignition-sensors6::ignition-sensors6-imu")
...
# Link the imu library to the "requested" target
...
if(NOT ign_requested_components)
  ...
  set_target_properties(ignition-sensors6::requested PROPERTIES
    INTERFACE_LINK_LIBRARIES "${ign_requested_components};ignition-sensors6::ignition-sensors6-imu")
endif()

set(ignition-sensors6-imu_LIBRARY ignition-sensors6::ignition-sensors6-imu)

# This macro is used by ignition-cmake to automatically configure the pkgconfig
# files for ignition projects.
ign_pkg_config_entry(ignition-sensors6-imu "ignition-sensors6-imu")
