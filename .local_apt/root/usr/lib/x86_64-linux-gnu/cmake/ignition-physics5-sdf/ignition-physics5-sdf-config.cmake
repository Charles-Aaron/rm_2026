# - Config file for the ignition-physics5-sdf component
#
# This should only be invoked by ignition-physics5-config.cmake.
#
# To load this component into your project, use:
# find_package(ignition-physics5 COMPONENTS sdf)
#
# This creates the following targets:
#
#   Component library target                - ignition-physics5::ignition-physics5-sdf
#   Alternative target name                 - ignition-physics5::sdf
...
# this is discouraged:
#
#   ignition-physics5-sdf_LIBRARY  - Component library (actually contains ignition-physics5::sdf)
#
# We will also set ignition-physics5-sdf_FOUND to indicate that the component was found.
#
################################################################################
...
if(ignition-physics5-sdf_CONFIG_INCLUDED)
  return()
endif()
set(ignition-physics5-sdf_CONFIG_INCLUDED TRUE)

if(NOT ignition-physics5-sdf_FIND_QUIETLY)
  message(STATUS "Looking for ignition-physics5-sdf -- found version 5.3.2")
endif()
...
get_filename_component(_realOrig "/usr/lib/x86_64-linux-gnu/cmake/ignition-physics5-sdf" REALPATH)
...
# dependencies.
if(ignition-physics5-sdf_FIND_REQUIRED)
...
# dependencies.
if(ignition-physics5-sdf_FIND_QUIETLY)
...
if(NOT ignition-physics5-sdf_FIND_QUIETLY)
  message(STATUS "Searching for dependencies of ignition-physics5-sdf")
endif()
...
if(NOT TARGET ignition-physics5::ignition-physics5-sdf)
  include("${CMAKE_CURRENT_LIST_DIR}/ignition-physics5-sdf-targets.cmake")

  # Create a simplified imported target name for the sdf library.
  # You can link to this target instead of the sdf library.
  add_library(ignition-physics5::sdf INTERFACE IMPORTED)
  set_target_properties(ignition-physics5::sdf PROPERTIES
    INTERFACE_LINK_LIBRARIES "ignition-physics5::ignition-physics5-sdf")
...
if(NOT ign_requested_components)
  ...
  set_target_properties(ignition-physics5::requested PROPERTIES
    INTERFACE_LINK_LIBRARIES "${ign_requested_components};ignition-physics5::ignition-physics5-sdf")
endif()

set(ignition-physics5-sdf_LIBRARY ignition-physics5::ignition-physics5-sdf)

# This macro is used by ignition-cmake to automatically configure the pkgconfig
# files for ignition projects.
ign_pkg_config_entry(ignition-physics5-sdf "ignition-physics5-sdf")
