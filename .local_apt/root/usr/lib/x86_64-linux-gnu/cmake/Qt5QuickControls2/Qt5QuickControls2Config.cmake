...
get_filename_component(_realOrig "/usr/lib/x86_64-linux-gnu/cmake/Qt5QuickControls2" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5QuickControls2_install_prefix "/usr/lib/x86_64-linux-gnu/../../" ABSOLUTE)
else()
...
set(Qt5QuickControls2_VERSION_STRING 5.15.3)
...
macro(_populate_QuickControls2_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5QuickControls2_install_prefix}/lib/x86_64-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::QuickControls2)
    ...
    set(_Qt5QuickControls2_OWN_INCLUDE_DIRS "${_qt5QuickControls2_install_prefix}/include/x86_64-linux-gnu/qt5/" "${_qt5QuickControls2_install_prefix}/include/x86_64-linux-gnu/qt5/QtQuickControls2")
    set(Qt5QuickControls2_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickControls2_install_prefix}/include/x86_64-linux-gnu/qt5/QtQuickControls2/5.15.3"
        "${_qt5QuickControls2_install_prefix}/include/x86_64-linux-gnu/qt5/QtQuickControls2/5.15.3/QtQuickControls2"
    )
    ...
    foreach(_module_dep ${_Qt5QuickControls2_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.3 ${_Qt5QuickControls2_FIND_VERSION_EXACT}
    ...
    _populate_QuickControls2_target_properties(RELEASE "libQt5QuickControls2.so.5.15.3" "" FALSE)
    ...
    macro(_populate_QuickControls2_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5QuickControls2_install_prefix}/lib/x86_64-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_QuickControls2_check_file_exists(${imported_location})
