...
/// For ignition-common4-profiler developers: Apply this macro to ignition-common4-profiler
...
/// For ignition-common4-profiler developers: Use this macro to indicate that a
