...
/// For ignition-common4-graphics developers: Apply this macro to ignition-common4-graphics
...
/// For ignition-common4-graphics developers: Use this macro to indicate that a
