...
#ifndef IGNITION_RENDERING_OGRE_EXPORT_HH_
#define IGNITION_RENDERING_OGRE_EXPORT_HH_
...
#include "gz/rendering/ogre/detail/Export.hh"


#ifndef IGNITION_RENDERING_OGRE_VISIBLE
/// For ignition-rendering6-ogre developers: Apply this macro to ignition-rendering6-ogre
/// functions and classes which consumers of this library will need to be able
/// to call from their own programs or libraries.
#define IGNITION_RENDERING_OGRE_VISIBLE \
  DETAIL_IGNITION_RENDERING_OGRE_VISIBLE
#endif


#ifndef IGNITION_RENDERING_OGRE_HIDDEN
/// For ignition-rendering6-ogre developers: Apply this macro to ignition-rendering6-ogre
...
/// not tagged with IGNITION_RENDERING_OGRE_VISIBLE, so this does not
/// generally need to be used.
#define IGNITION_RENDERING_OGRE_HIDDEN \
  DETAIL_IGNITION_RENDERING_OGRE_HIDDEN
#endif


#ifndef IGN_DEPRECATED
/// For ignition-rendering6-ogre developers: Use this macro to indicate that a
