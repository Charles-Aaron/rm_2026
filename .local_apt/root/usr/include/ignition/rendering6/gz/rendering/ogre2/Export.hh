...
#ifndef IGNITION_RENDERING_OGRE2_EXPORT_HH_
#define IGNITION_RENDERING_OGRE2_EXPORT_HH_
...
#ifndef IGNITION_RENDERING_OGRE2_VISIBLE
/// For ignition-rendering6-ogre2 developers: Apply this macro to ignition-rendering6-ogre2
/// functions and classes which consumers of this library will need to be able
/// to call from their own programs or libraries.
#define IGNITION_RENDERING_OGRE2_VISIBLE \
  DETAIL_IGNITION_RENDERING_OGRE2_VISIBLE
#endif


#ifndef IGNITION_RENDERING_OGRE2_HIDDEN
/// For ignition-rendering6-ogre2 developers: Apply this macro to ignition-rendering6-ogre2
...
/// not tagged with IGNITION_RENDERING_OGRE2_VISIBLE, so this does not
/// generally need to be used.
#define IGNITION_RENDERING_OGRE2_HIDDEN \
  DETAIL_IGNITION_RENDERING_OGRE2_HIDDEN
#endif


#ifndef IGN_DEPRECATED
/// For ignition-rendering6-ogre2 developers: Use this macro to indicate that a
