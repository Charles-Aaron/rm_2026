...
#ifndef IGNITION_PLUGIN_EXPORT_HH_
#define IGNITION_PLUGIN_EXPORT_HH_
...
#include "gz/plugin/detail/Export.hh"


#ifndef IGNITION_PLUGIN_VISIBLE
/// For ignition-plugin1 developers: Apply this macro to ignition-plugin1
/// functions and classes which consumers of this library will need to be able
/// to call from their own programs or libraries.
#define IGNITION_PLUGIN_VISIBLE \
  DETAIL_IGNITION_PLUGIN_VISIBLE
#endif


#ifndef IGNITION_PLUGIN_HIDDEN
/// For ignition-plugin1 developers: Apply this macro to ignition-plugin1
...
/// not tagged with IGNITION_PLUGIN_VISIBLE, so this does not
/// generally need to be used.
#define IGNITION_PLUGIN_HIDDEN \
  DETAIL_IGNITION_PLUGIN_HIDDEN
#endif


#ifndef IGN_DEPRECATED
/// For ignition-plugin1 developers: Use this macro to indicate that a
