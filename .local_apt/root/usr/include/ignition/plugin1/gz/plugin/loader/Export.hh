...
#ifndef IGNITION_PLUGIN_LOADER_EXPORT_HH_
#define IGNITION_PLUGIN_LOADER_EXPORT_HH_
...
#include "gz/plugin/loader/detail/Export.hh"


#ifndef IGNITION_PLUGIN_LOADER_VISIBLE
/// For ignition-plugin1-loader developers: Apply this macro to ignition-plugin1-loader
/// functions and classes which consumers of this library will need to be able
/// to call from their own programs or libraries.
#define IGNITION_PLUGIN_LOADER_VISIBLE \
  DETAIL_IGNITION_PLUGIN_LOADER_VISIBLE
#endif


#ifndef IGNITION_PLUGIN_LOADER_HIDDEN
/// For ignition-plugin1-loader developers: Apply this macro to ignition-plugin1-loader
...
/// not tagged with IGNITION_PLUGIN_LOADER_VISIBLE, so this does not
/// generally need to be used.
#define IGNITION_PLUGIN_LOADER_HIDDEN \
  DETAIL_IGNITION_PLUGIN_LOADER_HIDDEN
#endif


#ifndef IGN_DEPRECATED
/// For ignition-plugin1-loader developers: Use this macro to indicate that a
