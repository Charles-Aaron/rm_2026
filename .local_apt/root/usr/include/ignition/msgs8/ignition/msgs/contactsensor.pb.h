...
class IGNITION_MSGS_VISIBLE ContactSensor PROTOBUF_FINAL :
 ...
 public:
  ...
  void UnsafeArenaSwap(ContactSensor* other) {
    if (other == this) return;
  ...
  protected:
  explicit ContactSensor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  ...
  "    future release.")
  std::string* unsafe_arena_release_collision_name();
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  void unsafe_arena_set_allocated_collision_name(
...
// .ignition.msgs.Header header = 1;
inline bool ContactSensor::_internal_has_header() const {
...
inline void ContactSensor::unsafe_arena_set_allocated_header(
    ::ignition::msgs::Header* header) {
  if (GetArena() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ignition.msgs.ContactSensor.header)
}
...
inline ::ignition::msgs::Header* ContactSensor::unsafe_arena_release_header() {
...
inline ::ignition::msgs::Header* ContactSensor::_internal_mutable_header() {
...
inline void ContactSensor::clear_collision_name() {
  collision_name_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
...
inline const std::string& ContactSensor::_internal_collision_name() const {
  return collision_name_.Get();
}
inline void ContactSensor::_internal_set_collision_name(const std::string& value) {
  
  collision_name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
...
inline void ContactSensor::set_collision_name(const char* value) {
  ...
  collision_name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
...
inline void ContactSensor::set_collision_name(const char* value,
  ...
  collision_name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
...
inline std::string* ContactSensor::_internal_mutable_collision_name() {
  ...
  return collision_name_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* ContactSensor::release_collision_name() {
  ...
  return collision_name_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void ContactSensor::set_allocated_collision_name(std::string* collision_name) {
  ...
  collision_name_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), collision_name,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:ignition.msgs.ContactSensor.collision_name)
}
inline std::string* ContactSensor::unsafe_arena_release_collision_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:ignition.msgs.ContactSensor.collision_name)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return collision_name_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void ContactSensor::unsafe_arena_set_allocated_collision_name(
    std::string* collision_name) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (collision_name != nullptr) {
  ...
  collision_name_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      collision_name, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ignition.msgs.ContactSensor.collision_name)
}
