...
class IGNITION_MSGS_VISIBLE Publishers PROTOBUF_FINAL :
 ...
 public:
  ...
  protected:
  explicit Publishers(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
...
// .ignition.msgs.Header header = 1;
inline bool Publishers::_internal_has_header() const {
...
inline void Publishers::unsafe_arena_set_allocated_header(
    ::ignition::msgs::Header* header) {
  if (GetArena() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ignition.msgs.Publishers.header)
}
...
inline ::ignition::msgs::Header* Publishers::unsafe_arena_release_header() {
...
inline ::ignition::msgs::Header* Publishers::_internal_mutable_header() {
...
inline const ::ignition::msgs::Publish& Publishers::_internal_publisher(int index) const {
...
inline ::ignition::msgs::Publish* Publishers::_internal_add_publisher() {
