...
class IGNITION_MSGS_VISIBLE Tactile PROTOBUF_FINAL :
 ...
 public:
  ...
  void UnsafeArenaSwap(Tactile* other) {
    if (other == this) return;
  ...
  protected:
  explicit Tactile(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
 ...
 private:
  ...
  mutable std::atomic<int> _collision_id_cached_byte_size_;
...
// .ignition.msgs.Header header = 1;
inline bool Tactile::_internal_has_header() const {
...
inline void Tactile::unsafe_arena_set_allocated_header(
    ::ignition::msgs::Header* header) {
  if (GetArena() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ignition.msgs.Tactile.header)
}
...
inline ::ignition::msgs::Header* Tactile::unsafe_arena_release_header() {
...
inline ::ignition::msgs::Header* Tactile::_internal_mutable_header() {
