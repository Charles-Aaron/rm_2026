...
class IGNITION_MSGS_VISIBLE RaySensor PROTOBUF_FINAL :
 ...
 public:
  ...
  protected:
  explicit RaySensor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
...
// .ignition.msgs.Header header = 1;
inline bool RaySensor::_internal_has_header() const {
...
inline void RaySensor::unsafe_arena_set_allocated_header(
    ::ignition::msgs::Header* header) {
  if (GetArena() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ignition.msgs.RaySensor.header)
}
...
inline ::ignition::msgs::Header* RaySensor::unsafe_arena_release_header() {
...
inline ::ignition::msgs::Header* RaySensor::_internal_mutable_header() {
