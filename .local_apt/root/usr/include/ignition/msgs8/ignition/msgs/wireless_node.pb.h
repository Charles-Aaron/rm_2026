...
class IGNITION_MSGS_VISIBLE WirelessNode PROTOBUF_FINAL :
 ...
 public:
  ...
  protected:
  explicit WirelessNode(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  ...
  "    future release.")
  std::string* unsafe_arena_release_essid();
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  void unsafe_arena_set_allocated_essid(
      std::string* essid);
  private:
...
// .ignition.msgs.Header header = 1;
inline bool WirelessNode::_internal_has_header() const {
...
inline void WirelessNode::unsafe_arena_set_allocated_header(
    ::ignition::msgs::Header* header) {
  if (GetArena() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ignition.msgs.WirelessNode.header)
}
...
inline ::ignition::msgs::Header* WirelessNode::unsafe_arena_release_header() {
...
inline ::ignition::msgs::Header* WirelessNode::_internal_mutable_header() {
...
inline std::string* WirelessNode::unsafe_arena_release_essid() {
  // @@protoc_insertion_point(field_unsafe_arena_release:ignition.msgs.WirelessNode.essid)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return essid_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void WirelessNode::unsafe_arena_set_allocated_essid(
    std::string* essid) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (essid != nullptr) {
  ...
  essid_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      essid, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ignition.msgs.WirelessNode.essid)
}
