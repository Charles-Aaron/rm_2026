...
class IGNITION_MSGS_VISIBLE UInt32_V PROTOBUF_FINAL :
 ...
 public:
  ...
  void UnsafeArenaSwap(UInt32_V* other) {
    if (other == this) return;
  ...
  protected:
  explicit UInt32_V(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
...
// .ignition.msgs.Header header = 1;
inline bool UInt32_V::_internal_has_header() const {
...
inline void UInt32_V::unsafe_arena_set_allocated_header(
    ::ignition::msgs::Header* header) {
  if (GetArena() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ignition.msgs.UInt32_V.header)
}
...
inline ::ignition::msgs::Header* UInt32_V::unsafe_arena_release_header() {
...
inline ::ignition::msgs::Header* UInt32_V::_internal_mutable_header() {
...
// repeated uint32 data = 2;
inline int UInt32_V::_internal_data_size() const {
  return data_.size();
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 UInt32_V::_internal_data(int index) const {
...
inline void UInt32_V::_internal_add_data(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  data_.Add(value);
}
...
UInt32_V::_internal_mutable_data() {
  return &data_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< ::PROTOBUF_NAMESPACE_ID::uint32 >*
