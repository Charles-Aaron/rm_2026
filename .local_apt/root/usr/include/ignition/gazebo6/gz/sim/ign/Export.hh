...
#ifndef IGNITION_GAZEBO_IGN_EXPORT_HH_
#define IGNITION_GAZEBO_IGN_EXPORT_HH_
...
#include "gz/sim/ign/detail/Export.hh"


#ifndef IGNITION_GAZEBO_IGN_VISIBLE
/// For ignition-gazebo6-ign developers: Apply this macro to ignition-gazebo6-ign
/// functions and classes which consumers of this library will need to be able
/// to call from their own programs or libraries.
#define IGNITION_GAZEBO_IGN_VISIBLE \
  DETAIL_IGNITION_GAZEBO_IGN_VISIBLE
#endif


#ifndef IGNITION_GAZEBO_IGN_HIDDEN
/// For ignition-gazebo6-ign developers: Apply this macro to ignition-gazebo6-ign
...
/// not tagged with IGNITION_GAZEBO_IGN_VISIBLE, so this does not
/// generally need to be used.
#define IGNITION_GAZEBO_IGN_HIDDEN \
  DETAIL_IGNITION_GAZEBO_IGN_HIDDEN
#endif


#ifndef IGN_DEPRECATED
/// For ignition-gazebo6-ign developers: Use this macro to indicate that a
