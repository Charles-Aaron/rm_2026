...
#ifndef IGNITION_GAZEBO_POSE_PUBLISHER_SYSTEM_EXPORT_HH_
#define IGNITION_GAZEBO_POSE_PUBLISHER_SYSTEM_EXPORT_HH_
...
#include "gz/sim/pose-publisher-system/detail/Export.hh"


#ifndef IGNITION_GAZEBO_POSE_PUBLISHER_SYSTEM_VISIBLE
/// For ignition-gazebo6-pose-publisher-system developers: Apply this macro to ignition-gazebo6-pose-publisher-system
/// functions and classes which consumers of this library will need to be able
/// to call from their own programs or libraries.
#define IGNITION_GAZEBO_POSE_PUBLISHER_SYSTEM_VISIBLE \
  DETAIL_IGNITION_GAZEBO_POSE_PUBLISHER_SYSTEM_VISIBLE
#endif


#ifndef IGNITION_GAZEBO_POSE_PUBLISHER_SYSTEM_HIDDEN
/// For ignition-gazebo6-pose-publisher-system developers: Apply this macro to ignition-gazebo6-pose-publisher-system
...
/// not tagged with IGNITION_GAZEBO_POSE_PUBLISHER_SYSTEM_VISIBLE, so this does not
/// generally need to be used.
#define IGNITION_GAZEBO_POSE_PUBLISHER_SYSTEM_HIDDEN \
  DETAIL_IGNITION_GAZEBO_POSE_PUBLISHER_SYSTEM_HIDDEN
#endif


#ifndef IGN_DEPRECATED
/// For ignition-gazebo6-pose-publisher-system developers: Use this macro to indicate that a
