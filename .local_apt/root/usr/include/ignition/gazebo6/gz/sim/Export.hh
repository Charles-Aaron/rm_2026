...
#include "gz/sim/detail/Export.hh"


#ifndef IGNITION_GAZEBO_VISIBLE
/// For ignition-gazebo6 developers: Apply this macro to ignition-gazebo6
...
#define IGNITION_GAZEBO_VISIBLE \
  DETAIL_IGNITION_GAZEBO_VISIBLE
#endif


#ifndef IGNITION_GAZEBO_HIDDEN
/// For ignition-gazebo6 developers: Apply this macro to ignition-gazebo6
...
/// not tagged with IGNITION_GAZEBO_VISIBLE, so this does not
/// generally need to be used.
#define IGNITION_GAZEBO_HIDDEN \
  DETAIL_IGNITION_GAZEBO_HIDDEN
#endif


#ifndef IGN_DEPRECATED
/// For ignition-gazebo6 developers: Use this macro to indicate that a
