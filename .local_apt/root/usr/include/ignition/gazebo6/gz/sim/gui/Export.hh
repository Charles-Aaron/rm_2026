...
#ifndef IGNITION_GAZEBO_GUI_EXPORT_HH_
#define IGNITION_GAZEBO_GUI_EXPORT_HH_
...
#include "gz/sim/gui/detail/Export.hh"


#ifndef IGNITION_GAZEBO_GUI_VISIBLE
/// For ignition-gazebo6-gui developers: Apply this macro to ignition-gazebo6-gui
/// functions and classes which consumers of this library will need to be able
/// to call from their own programs or libraries.
#define IGNITION_GAZEBO_GUI_VISIBLE \
  DETAIL_IGNITION_GAZEBO_GUI_VISIBLE
#endif


#ifndef IGNITION_GAZEBO_GUI_HIDDEN
/// For ignition-gazebo6-gui developers: Apply this macro to ignition-gazebo6-gui
...
/// not tagged with IGNITION_GAZEBO_GUI_VISIBLE, so this does not
/// generally need to be used.
#define IGNITION_GAZEBO_GUI_HIDDEN \
  DETAIL_IGNITION_GAZEBO_GUI_HIDDEN
#endif


#ifndef IGN_DEPRECATED
/// For ignition-gazebo6-gui developers: Use this macro to indicate that a
