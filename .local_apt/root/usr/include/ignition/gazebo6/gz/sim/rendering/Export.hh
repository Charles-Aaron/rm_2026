...
#ifndef IGNITION_GAZEBO_RENDERING_EXPORT_HH_
#define IGNITION_GAZEBO_RENDERING_EXPORT_HH_
...
#include "gz/sim/rendering/detail/Export.hh"


#ifndef IGNITION_GAZEBO_RENDERING_VISIBLE
/// For ignition-gazebo6-rendering developers: Apply this macro to ignition-gazebo6-rendering
/// functions and classes which consumers of this library will need to be able
/// to call from their own programs or libraries.
#define IGNITION_GAZEBO_RENDERING_VISIBLE \
  DETAIL_IGNITION_GAZEBO_RENDERING_VISIBLE
#endif


#ifndef IGNITION_GAZEBO_RENDERING_HIDDEN
/// For ignition-gazebo6-rendering developers: Apply this macro to ignition-gazebo6-rendering
...
/// not tagged with IGNITION_GAZEBO_RENDERING_VISIBLE, so this does not
/// generally need to be used.
#define IGNITION_GAZEBO_RENDERING_HIDDEN \
  DETAIL_IGNITION_GAZEBO_RENDERING_HIDDEN
#endif


#ifndef IGN_DEPRECATED
/// For ignition-gazebo6-rendering developers: Use this macro to indicate that a
