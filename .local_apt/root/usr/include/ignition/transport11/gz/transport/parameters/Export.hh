...
#ifndef IGNITION_TRANSPORT_PARAMETERS_EXPORT_HH_
#define IGNITION_TRANSPORT_PARAMETERS_EXPORT_HH_
...
#include "gz/transport/parameters/detail/Export.hh"


#ifndef IGNITION_TRANSPORT_PARAMETERS_VISIBLE
/// For ignition-transport11-parameters developers: Apply this macro to ignition-transport11-parameters
/// functions and classes which consumers of this library will need to be able
/// to call from their own programs or libraries.
#define IGNITION_TRANSPORT_PARAMETERS_VISIBLE \
  DETAIL_IGNITION_TRANSPORT_PARAMETERS_VISIBLE
#endif


#ifndef IGNITION_TRANSPORT_PARAMETERS_HIDDEN
/// For ignition-transport11-parameters developers: Apply this macro to ignition-transport11-parameters
...
/// not tagged with IGNITION_TRANSPORT_PARAMETERS_VISIBLE, so this does not
/// generally need to be used.
#define IGNITION_TRANSPORT_PARAMETERS_HIDDEN \
  DETAIL_IGNITION_TRANSPORT_PARAMETERS_HIDDEN
#endif


#ifndef IGN_DEPRECATED
/// For ignition-transport11-parameters developers: Use this macro to indicate that a
