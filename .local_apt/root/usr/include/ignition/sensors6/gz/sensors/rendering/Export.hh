...
#ifndef IGNITION_SENSORS_RENDERING_EXPORT_HH_
#define IGNITION_SENSORS_RENDERING_EXPORT_HH_
...
#include "gz/sensors/rendering/detail/Export.hh"


#ifndef IGNITION_SENSORS_RENDERING_VISIBLE
/// For ignition-sensors6-rendering developers: Apply this macro to ignition-sensors6-rendering
/// functions and classes which consumers of this library will need to be able
/// to call from their own programs or libraries.
#define IGNITION_SENSORS_RENDERING_VISIBLE \
  DETAIL_IGNITION_SENSORS_RENDERING_VISIBLE
#endif


#ifndef IGNITION_SENSORS_RENDERING_HIDDEN
/// For ignition-sensors6-rendering developers: Apply this macro to ignition-sensors6-rendering
...
/// not tagged with IGNITION_SENSORS_RENDERING_VISIBLE, so this does not
/// generally need to be used.
#define IGNITION_SENSORS_RENDERING_HIDDEN \
  DETAIL_IGNITION_SENSORS_RENDERING_HIDDEN
#endif


#ifndef IGN_DEPRECATED
/// For ignition-sensors6-rendering developers: Use this macro to indicate that a
