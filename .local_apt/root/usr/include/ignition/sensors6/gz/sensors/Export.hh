...
#ifndef IGNITION_SENSORS_EXPORT_HH_
#define IGNITION_SENSORS_EXPORT_HH_
...
#include "gz/sensors/detail/Export.hh"


#ifndef IGNITION_SENSORS_VISIBLE
/// For ignition-sensors6 developers: Apply this macro to ignition-sensors6
/// functions and classes which consumers of this library will need to be able
/// to call from their own programs or libraries.
#define IGNITION_SENSORS_VISIBLE \
  DETAIL_IGNITION_SENSORS_VISIBLE
#endif


#ifndef IGNITION_SENSORS_HIDDEN
/// For ignition-sensors6 developers: Apply this macro to ignition-sensors6
...
/// not tagged with IGNITION_SENSORS_VISIBLE, so this does not
/// generally need to be used.
#define IGNITION_SENSORS_HIDDEN \
  DETAIL_IGNITION_SENSORS_HIDDEN
#endif


#ifndef IGN_DEPRECATED
/// For ignition-sensors6 developers: Use this macro to indicate that a
