...
#ifndef IGNITION_SENSORS_FORCE_TORQUE_EXPORT_HH_
#define IGNITION_SENSORS_FORCE_TORQUE_EXPORT_HH_
...
#include "gz/sensors/force_torque/detail/Export.hh"


#ifndef IGNITION_SENSORS_FORCE_TORQUE_VISIBLE
/// For ignition-sensors6-force_torque developers: Apply this macro to ignition-sensors6-force_torque
/// functions and classes which consumers of this library will need to be able
/// to call from their own programs or libraries.
#define IGNITION_SENSORS_FORCE_TORQUE_VISIBLE \
  DETAIL_IGNITION_SENSORS_FORCE_TORQUE_VISIBLE
#endif


#ifndef IGNITION_SENSORS_FORCE_TORQUE_HIDDEN
/// For ignition-sensors6-force_torque developers: Apply this macro to ignition-sensors6-force_torque
...
/// not tagged with IGNITION_SENSORS_FORCE_TORQUE_VISIBLE, so this does not
/// generally need to be used.
#define IGNITION_SENSORS_FORCE_TORQUE_HIDDEN \
  DETAIL_IGNITION_SENSORS_FORCE_TORQUE_HIDDEN
#endif


#ifndef IGN_DEPRECATED
/// For ignition-sensors6-force_torque developers: Use this macro to indicate that a
