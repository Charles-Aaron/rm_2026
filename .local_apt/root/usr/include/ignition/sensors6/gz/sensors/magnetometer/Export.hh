...
#ifndef IGNITION_SENSORS_MAGNETOMETER_EXPORT_HH_
#define IGNITION_SENSORS_MAGNETOMETER_EXPORT_HH_
...
#include "gz/sensors/magnetometer/detail/Export.hh"


#ifndef IGNITION_SENSORS_MAGNETOMETER_VISIBLE
/// For ignition-sensors6-magnetometer developers: Apply this macro to ignition-sensors6-magnetometer
/// functions and classes which consumers of this library will need to be able
/// to call from their own programs or libraries.
#define IGNITION_SENSORS_MAGNETOMETER_VISIBLE \
  DETAIL_IGNITION_SENSORS_MAGNETOMETER_VISIBLE
#endif


#ifndef IGNITION_SENSORS_MAGNETOMETER_HIDDEN
/// For ignition-sensors6-magnetometer developers: Apply this macro to ignition-sensors6-magnetometer
...
/// not tagged with IGNITION_SENSORS_MAGNETOMETER_VISIBLE, so this does not
/// generally need to be used.
#define IGNITION_SENSORS_MAGNETOMETER_HIDDEN \
  DETAIL_IGNITION_SENSORS_MAGNETOMETER_HIDDEN
#endif


#ifndef IGN_DEPRECATED
/// For ignition-sensors6-magnetometer developers: Use this macro to indicate that a
