...
#ifndef IGNITION_SENSORS_IMU_EXPORT_HH_
#define IGNITION_SENSORS_IMU_EXPORT_HH_
...
#include "gz/sensors/imu/detail/Export.hh"


#ifndef IGNITION_SENSORS_IMU_VISIBLE
/// For ignition-sensors6-imu developers: Apply this macro to ignition-sensors6-imu
/// functions and classes which consumers of this library will need to be able
/// to call from their own programs or libraries.
#define IGNITION_SENSORS_IMU_VISIBLE \
  DETAIL_IGNITION_SENSORS_IMU_VISIBLE
#endif


#ifndef IGNITION_SENSORS_IMU_HIDDEN
/// For ignition-sensors6-imu developers: Apply this macro to ignition-sensors6-imu
...
/// not tagged with IGNITION_SENSORS_IMU_VISIBLE, so this does not
/// generally need to be used.
#define IGNITION_SENSORS_IMU_HIDDEN \
  DETAIL_IGNITION_SENSORS_IMU_HIDDEN
#endif


#ifndef IGN_DEPRECATED
/// For ignition-sensors6-imu developers: Use this macro to indicate that a
