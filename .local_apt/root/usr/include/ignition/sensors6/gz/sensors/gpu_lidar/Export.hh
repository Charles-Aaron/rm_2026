...
#ifndef IGNITION_SENSORS_GPU_LIDAR_EXPORT_HH_
#define IGNITION_SENSORS_GPU_LIDAR_EXPORT_HH_
...
#include "gz/sensors/gpu_lidar/detail/Export.hh"


#ifndef IGNITION_SENSORS_GPU_LIDAR_VISIBLE
/// For ignition-sensors6-gpu_lidar developers: Apply this macro to ignition-sensors6-gpu_lidar
/// functions and classes which consumers of this library will need to be able
/// to call from their own programs or libraries.
#define IGNITION_SENSORS_GPU_LIDAR_VISIBLE \
  DETAIL_IGNITION_SENSORS_GPU_LIDAR_VISIBLE
#endif


#ifndef IGNITION_SENSORS_GPU_LIDAR_HIDDEN
/// For ignition-sensors6-gpu_lidar developers: Apply this macro to ignition-sensors6-gpu_lidar
...
/// not tagged with IGNITION_SENSORS_GPU_LIDAR_VISIBLE, so this does not
/// generally need to be used.
#define IGNITION_SENSORS_GPU_LIDAR_HIDDEN \
  DETAIL_IGNITION_SENSORS_GPU_LIDAR_HIDDEN
#endif


#ifndef IGN_DEPRECATED
/// For ignition-sensors6-gpu_lidar developers: Use this macro to indicate that a
