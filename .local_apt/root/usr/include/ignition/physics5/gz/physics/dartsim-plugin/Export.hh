...
#ifndef IGNITION_PHYSICS_DARTSIM_PLUGIN_EXPORT_HH_
#define IGNITION_PHYSICS_DARTSIM_PLUGIN_EXPORT_HH_
...
#include "gz/physics/dartsim-plugin/detail/Export.hh"


#ifndef IGNITION_PHYSICS_DARTSIM_PLUGIN_VISIBLE
/// For ignition-physics5-dartsim-plugin developers: Apply this macro to ignition-physics5-dartsim-plugin
/// functions and classes which consumers of this library will need to be able
/// to call from their own programs or libraries.
#define IGNITION_PHYSICS_DARTSIM_PLUGIN_VISIBLE \
  DETAIL_IGNITION_PHYSICS_DARTSIM_PLUGIN_VISIBLE
#endif


#ifndef IGNITION_PHYSICS_DARTSIM_PLUGIN_HIDDEN
/// For ignition-physics5-dartsim-plugin developers: Apply this macro to ignition-physics5-dartsim-plugin
...
/// not tagged with IGNITION_PHYSICS_DARTSIM_PLUGIN_VISIBLE, so this does not
/// generally need to be used.
#define IGNITION_PHYSICS_DARTSIM_PLUGIN_HIDDEN \
  DETAIL_IGNITION_PHYSICS_DARTSIM_PLUGIN_HIDDEN
#endif


#ifndef IGN_DEPRECATED
/// For ignition-physics5-dartsim-plugin developers: Use this macro to indicate that a
