...
#ifndef IGNITION_PHYSICS_TPELIB_EXPORT_HH_
#define IGNITION_PHYSICS_TPELIB_EXPORT_HH_
...
#include "gz/physics/tpelib/detail/Export.hh"


#ifndef IGNITION_PHYSICS_TPELIB_VISIBLE
/// For ignition-physics5-tpelib developers: Apply this macro to ignition-physics5-tpelib
/// functions and classes which consumers of this library will need to be able
/// to call from their own programs or libraries.
#define IGNITION_PHYSICS_TPELIB_VISIBLE \
  DETAIL_IGNITION_PHYSICS_TPELIB_VISIBLE
#endif


#ifndef IGNITION_PHYSICS_TPELIB_HIDDEN
/// For ignition-physics5-tpelib developers: Apply this macro to ignition-physics5-tpelib
...
/// not tagged with IGNITION_PHYSICS_TPELIB_VISIBLE, so this does not
/// generally need to be used.
#define IGNITION_PHYSICS_TPELIB_HIDDEN \
  DETAIL_IGNITION_PHYSICS_TPELIB_HIDDEN
#endif


#ifndef IGN_DEPRECATED
/// For ignition-physics5-tpelib developers: Use this macro to indicate that a
