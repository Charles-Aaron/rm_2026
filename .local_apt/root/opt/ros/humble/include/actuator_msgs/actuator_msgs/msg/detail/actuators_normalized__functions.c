...
actuator_msgs__msg__ActuatorsNormalized__init(actuator_msgs__msg__ActuatorsNormalized * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    actuator_msgs__msg__ActuatorsNormalized__fini(msg);
    return false;
  }
  // normalized
...
actuator_msgs__msg__ActuatorsNormalized__create()
{
  ...
  actuator_msgs__msg__ActuatorsNormalized * msg = (actuator_msgs__msg__ActuatorsNormalized *)allocator.allocate(sizeof(actuator_msgs__msg__ActuatorsNormalized), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(actuator_msgs__msg__ActuatorsNormalized));
  bool success = actuator_msgs__msg__ActuatorsNormalized__init(msg);
  if (!success) {
...
actuator_msgs__msg__ActuatorsNormalized__Sequence__init(actuator_msgs__msg__ActuatorsNormalized__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  actuator_msgs__msg__ActuatorsNormalized * data = NULL;

  if (size) {
    data = (actuator_msgs__msg__ActuatorsNormalized *)allocator.zero_allocate(size, sizeof(actuator_msgs__msg__ActuatorsNormalized), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = actuator_msgs__msg__ActuatorsNormalized__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        actuator_msgs__msg__ActuatorsNormalized__fini(&data[i - 1]);
      }
...
actuator_msgs__msg__ActuatorsNormalized__Sequence__fini(actuator_msgs__msg__ActuatorsNormalized__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      actuator_msgs__msg__ActuatorsNormalized__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  actuator_msgs__msg__ActuatorsNormalized__Sequence * array = (actuator_msgs__msg__ActuatorsNormalized__Sequence *)allocator.allocate(sizeof(actuator_msgs__msg__ActuatorsNormalized__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = actuator_msgs__msg__ActuatorsNormalized__Sequence__init(array, size);
  if (!success) {
...
actuator_msgs__msg__ActuatorsNormalized__Sequence__destroy(actuator_msgs__msg__ActuatorsNormalized__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    actuator_msgs__msg__ActuatorsNormalized__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
actuator_msgs__msg__ActuatorsNormalized__Sequence__are_equal(const actuator_msgs__msg__ActuatorsNormalized__Sequence * lhs, const actuator_msgs__msg__ActuatorsNormalized__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!actuator_msgs__msg__ActuatorsNormalized__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  actuator_msgs__msg__ActuatorsNormalized__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(actuator_msgs__msg__ActuatorsNormalized);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    actuator_msgs__msg__ActuatorsNormalized * data =
      (actuator_msgs__msg__ActuatorsNormalized *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!actuator_msgs__msg__ActuatorsNormalized__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          actuator_msgs__msg__ActuatorsNormalized__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!actuator_msgs__msg__ActuatorsNormalized__copy(
