...
bool ros_gz_interfaces__msg__log_playback_statistics__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros_gz_interfaces.msg._log_playback_statistics.LogPlaybackStatistics", full_classname_dest, 68) == 0);
  }
  ros_gz_interfaces__msg__LogPlaybackStatistics * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of LogPlaybackStatistics */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros_gz_interfaces.msg._log_playback_statistics");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LogPlaybackStatistics");
