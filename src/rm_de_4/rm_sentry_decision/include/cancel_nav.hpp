#ifndef RM_SENTRY_DECISION__CANCEL_NAV_HPP_
#define RM_SENTRY_DECISION__CANCEL_NAV_HPP_
...
class CancelNav : public BT::ConditionNode {
public:
    CancelNav(const std::string& name, 
