#ifndef RM_SENTRY_DECISION__ATTACK_STRATEGY_HPP_
#define RM_SENTRY_DECISION__ATTACK_STRATEGY_HPP_
...
class AttackStrategy : public BT::ConditionNode {
public:
  AttackStrategy(const std::string &name, const BT::NodeConfiguration &config);

  static BT::PortsList providedPorts() {
    return { BT::OutputPort<bool>("attack_enemy_base") };
  }
...
#endif // RM_SENTRY_DECISION__ATTACK_STRATEGY_HPP_ 