#ifndef ACTION_FORT_HPP
#define ACTION_FORT_HPP
...
class action_fort : public BT::StatefulActionNode {
public:
    using NavigateToPose = nav2_msgs::action::NavigateToPose;

    action_fort(const std::string& name, const BT::NodeConfiguration& config);
