#ifndef ACTION_FREE_HPP
#define ACTION_FREE_HPP
...
class action_free : public BT::StatefulActionNode {
public:
    using NavigateToPose = nav2_msgs::action::NavigateToPose;

    action_free(const std::string& name, const BT::NodeConfiguration& config);
