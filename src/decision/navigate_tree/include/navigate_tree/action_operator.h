#ifndef ACTION_OPERATOR_HPP
#define ACTION_OPERATOR_HPP
...
class action_operator : public BT::StatefulActionNode {
public:
    using NavigateToPose = nav2_msgs::action::NavigateToPose;

    action_operator(const std::string& name, const BT::NodeConfiguration& config);
