#ifndef ACTION_TOWER_HPP
#define ACTION_TOWER_HPP
...
class action_tower : public BT::StatefulActionNode {
public:
    using NavigateToPose = nav2_msgs::action::NavigateToPose;

    action_tower(const std::string& name, const BT::NodeConfiguration& config);
