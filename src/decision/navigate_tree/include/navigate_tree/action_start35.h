#ifndef ACTION_START35_HPP
#define ACTION_START35_HPP
...
class action_start35 : public BT::StatefulActionNode {
public:
    using NavigateToPose = nav2_msgs::action::NavigateToPose;

    action_start35(const std::string& name, const BT::NodeConfiguration& config);
