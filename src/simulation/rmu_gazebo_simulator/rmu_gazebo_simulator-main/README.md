...
```bash
git clone https://github.com/SMBU-PolarBear-Robotics-Team/rmu_gazebo_simulator.git src/simulation/rmu_gazebo_simulator
```

```bash
vcs import src < src/simulation/rmu_gazebo_simulator/dependencies.repos
```
...
```sh
python3 src/simulation/rmu_gazebo_simulator/rmu_gazebo_simulator/scripts/player_web/main_no_vision.py
```
...
```sh
python3 src/simulation/rmu_gazebo_simulator/rmu_gazebo_simulator/scripts/referee_web/main.py
```
