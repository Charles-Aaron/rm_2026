...
const rosmsg_1 = require("@lichtblick/rosmsg");
const parser_babel_1 = tslib_1.__importDefault(require("prettier/parser-babel"));
const standalone_1 = tslib_1.__importDefault(require("prettier/standalone"));
const LazyMessageReader_1 = require("./LazyMessageReader");
const messageReaderTests_1 = tslib_1.__importDefault(require("./fixtures/messageReaderTests"));
describe("LazyReader", () => {
